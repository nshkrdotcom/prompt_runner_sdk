defmodule PromptRunner.CLI do
  ...
  defp show_help do
    ...
    IO.puts("    %{")
    IO.puts("      project_dir: \"/path/to/project\",")
    IO.puts("")
    IO.puts("      target_repos: [")
    IO.puts("        %{name: \"command\", path: \"/path/to/command\", default: true},")
    IO.puts("        %{name: \"flowstone\", path: \"/path/to/flowstone\"}")
    IO.puts("      ],")
    IO.puts("")
    IO.puts("      llm: %{")
    ...
    IO.puts("      },")
    IO.puts("")
    IO.puts("      prompts_file: \"prompts.txt\",")
    IO.puts("      commit_messages_file: \"commit-messages.txt\",")
    IO.puts("      progress_file: \".progress\",")
    IO.puts("      log_dir: \"../logs\",")
    IO.puts("      model: \"sonnet\",")
    IO.puts("      allowed_tools: [\"Read\", \"Write\"],")
    IO.puts("      permission_mode: :accept_edits,")
    IO.puts("      log_mode: :compact,")
    IO.puts("      log_meta: :none,")
    IO.puts("      events_mode: :compact,")
    IO.puts("      phase_names: %{1 => \"Phase One\"}")
    IO.puts("    }")
    IO.puts("")
